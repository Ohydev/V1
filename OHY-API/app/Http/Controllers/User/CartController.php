...
class CartController extends Controller
{
    ...
    public function addCartItem(Request $request)
    {
        ...
        if (! $validation->fails()) {
            try {
                ...
                $ticketQueryCondition = ['ticket_id' => $data['ticket_id']];
    ...
    public function getCartItems(Request $request)
    {
        ...
        try {
            ...
            $cartQueryCondition = ['user_id' => $user->user_id];
        ...
        if (! $validation->fails()) {
            try {
                ...
                if ($data['quantity'] == 0) {
                    ...
                    // Prepare query condition to find ticket by ticket_id
                    $ticketQueryCondition = ['ticket_id' => $ticketId];
        ...
        if (! $validation->fails()) {
            try {
                ...
                if (isset($data['coupon_id']) && (int) $data['coupon_id'] >= 1) {
                    $couponQueryCondition = ['coupon_id' => (int) $data['coupon_id']];
                } else {
                    $couponInput = trim((string) $data['coupon']);
                    if (ctype_digit($couponInput) && (int) $couponInput >= 1) {
                        $couponQueryCondition = ['coupon_id' => (int) $couponInput];
                    } else {
                        $couponQueryCondition = ['coupon_code' => $couponInput];
                    }
                }
        ...
        if (! $validation->fails()) {
            try {
                ...
                if (isset($data['coupon_id']) && ! empty($data['coupon_id'])) {
                    ...
                    $couponQueryCondition = ['coupon_id' => $data['coupon_id']];
