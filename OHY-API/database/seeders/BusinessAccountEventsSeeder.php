...
class BusinessAccountEventsSeeder extends Seeder
{
    /**
     * Run the database seeds.
     * 
     * Creates 4 complete events for Business account host:
    ...
    public function run(): void
    {
        ...
        // Get the Business account host user ID
        ...
        $hostUserId = DB::table('host_users')
            ...
            ->where('businesses.account_type', 'business')
